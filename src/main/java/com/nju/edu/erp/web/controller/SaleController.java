...
public class SaleController {
    ...
    private List<PromotionStrategy> promotionStrategyList;
    ...
    @Autowired
    public SaleController(SaleService saleService, PromotionStrategyByUserLevel promotionStrategyByUserLevel, PromotionStrategyByPricePacks promotionStrategyByPricePacks, PromotionStrategyByTotalPrice promotionStrategyByTotalPrice) {
        ...
        this.promotionStrategyList = new ArrayList<>();
    }

    /**
     * 销售人员制定销售单
     */
    @Authorized (roles = {Role.SALE_STAFF, Role.SALE_MANAGER, Role.FINANCIAL_STAFF, Role.GM, Role.ADMIN})
    @PostMapping(value = "/sheet-make")
    public Response makePurchaseOrder(UserVO userVO, @RequestBody SaleSheetVO saleSheetVO)  {
        saleService.makeSaleSheet(userVO, saleSheetVO, this.promotionStrategyList);
        this.promotionStrategyList = new ArrayList<>();
    ...
    public Response addLevel()  {
        this.promotionStrategyList.add(promotionStrategyByUserLevel);
        return Response.buildSuccess();
    }
    ...
    public Response addPack()  {
        this.promotionStrategyList.add(promotionStrategyByPricePacks);
        return Response.buildSuccess();
    }
     ...
     */
    @Authorized (roles = {Role.SALE_STAFF, Role.SALE_MANAGER, Role.FINANCIAL_STAFF, Role.GM, Role.ADMIN})
    @PostMapping(value = "/add-total")
    public Response addTotal()  {
        this.promotionStrategyList.add(promotionStrategyByTotalPrice);
        return Response.buildSuccess();
    }
