...
public interface PurchaseService {
    ...
    List<PurchaseSheetPO> findAllByCreateTime(Date beginTime, Date endTime);

    List<PurchaseSheetPO> findAll();

    List<PurchaseSheetPO> findAllByCustomerId(Integer id);

    List<PurchaseSheetPO> findAllByOperatorName(String operator);
