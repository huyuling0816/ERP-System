...
public class WarehouseServiceImpl implements WarehouseService {
    ...
    @Override
    public List<String> queryAllWarehouseId() {
        return warehouseDao.findAllId();
    }
...
//            warehouseDao.deductQuantity(warehousePO);
    ...
    public List<WarehouseIODetailPO> getWarehouseIODetailByTime(String beginDateStr, String endDateStr) {
         ...
         *
         */
        List<WarehouseIODetailPO> result = new ArrayList<>();
        ...
        try {
            ...
            if (beginDate.compareTo(endDate) > 0) {
                ...
                List<WarehouseIODetailPO> listInput = warehouseInputSheetDao.getWarehouseIODetailByTime(beginDate, endDate);
                for (WarehouseIODetailPO w : listInput) {
                    result.add(w);
                }
            }
    ...
    public int getWarehouseInputProductQuantityByTime(String beginDateStr, String endDateStr) {
        ...
        try {
            ...
            if (beginDate.compareTo(endDate) > 0) {
                ...
                if (warehouseInputSheetDao.getWarehouseInputProductQuantityByTime(beginDate, endDate) == null) {
                    return 0;
                }
                return warehouseInputSheetDao.getWarehouseInputProductQuantityByTime(beginDate, endDate);
            }
        } catch (ParseException e) {
            e.printStackTrace();
        }
    ...
    public int getWarehouseOutProductQuantityByTime(String beginDateStr, String endDateStr) {
        ...
        try {
            ...
            if (beginDate.compareTo(endDate) > 0) {
                ...
                if (warehouseOutputSheetDao.getWarehouseOutputProductQuantityByTime(beginDate, endDate) == null) {
                    return 0;
                }
                return warehouseOutputSheetDao.getWarehouseOutputProductQuantityByTime(beginDate, endDate);
            }
        } catch (ParseException e) {
            e.printStackTrace();
        }
