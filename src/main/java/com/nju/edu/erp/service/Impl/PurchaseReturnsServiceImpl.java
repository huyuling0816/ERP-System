...
public class PurchaseReturnsServiceImpl implements PurchaseReturnsService {
    ...
    @Transactional
    @Override
    public PurchaseReturnsSheetVO getPurchaseReturnsById(String purchaseReturnsSheetId) {
        ...
        PurchaseReturnsSheetVO sVO = new PurchaseReturnsSheetVO();
        BeanUtils.copyProperties(purchaseReturnsSheetPO, sVO);
        List<PurchaseReturnsSheetContentVO> purchaseReturnsSheetContentVOList = new ArrayList<>();
        for (PurchaseReturnsSheetContentPO content:
                contentPO) {
            PurchaseReturnsSheetContentVO sContentVO = new PurchaseReturnsSheetContentVO();
            BeanUtils.copyProperties(content, sContentVO);
            purchaseReturnsSheetContentVOList.add(sContentVO);
        }
        sVO.setPurchaseReturnsSheetContent(purchaseReturnsSheetContentVOList);
        return sVO;
    }

    @Transactional
    @Override
    public List<PurchaseReturnsSheetPO> findAllByCreateTime(Date beginTime, Date endTime) {
        return purchaseReturnsSheetDao.findAllByCreateTime(beginTime, endTime);
    }

    @Transactional
    @Override
    public List<PurchaseReturnsSheetPO> findAll() {
        return purchaseReturnsSheetDao.findAll();
    }

    @Transactional
    @Override
    public List<PurchaseReturnsSheetPO> findAllByCustomerId(Integer id) {
        return purchaseReturnsSheetDao.findAllByCustomerId(id);
    }

    @Transactional
    @Override
    public List<PurchaseReturnsSheetPO> findAllByOperatorName(String operator){
        return purchaseReturnsSheetDao.findAllByOperatorName(operator);
    }
}